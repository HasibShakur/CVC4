 ...
 * expression.
 */
std::string SmtEngine::eliminateQuantifier(Expr ex, int numbOfQuantifiersToEliminate) {
  Assert(ex.getExprManager() == d_exprManager);
  SmtScope smts(this);
  Debug("expr-qetest")<<"Num of Quantifiers to Eliminate "<<numbOfQuantifiersToEliminate<<"\n"
